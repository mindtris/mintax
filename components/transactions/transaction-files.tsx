...
import { File, Transaction } from "@/lib/prisma/client"
  ...
  return (
    <>
      ...
      <Card className="relative min-h-32 p-4">
        ...
        <label
          className="h-full w-full flex flex-col gap-2 items-center justify-center p-4 border-2 border-dashed border-border rounded-lg cursor-pointer hover:border-primary transition-colors"
          onDragEnter={(e) => {
        ...
        >
          {isUploading ? (
            ...
            <>
              ...
              <p className="text-sm text-muted-foreground">Add more files to this invoice</p>
              <p className="text-xs text-muted-foreground">(or just drop them on this page)</p>
            </>
          )}
          <input
            multiple
