...
export const chartColors = {
  ...
  charts: {
    1: 'hsl(14 53% 43%)', // Mintax Primary (Terracotta)
    2: 'hsl(254 85% 74%)', // Mintax Secondary (Lavender)
    3: 'hsl(40 22% 82%)', // Mintax Muted (Beige)
    4: 'hsl(254 50% 83%)', // Mintax Light Purple
    5: 'hsl(14 62% 44%)', // Mintax Dark Earth
  }
};
