  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-accent/40 [&:has([aria-selected].day-outside)]:bg-accent/20 [&:has([aria-selected].day-range-end)]:rounded-r-full",
          props.mode === "range"
